...
import AR.algorithm.fpm.FPGrowth.ArrayWrapper
...
class FPGrowth(private var minSupport: Double, private var numPartitions: Int) extends Serializable {
  ...
  private def genCondTransactions(transaction: Array[Int], itemToRank: Map[Int, Int], partitioner: Partitioner): mutable.Map[Int, Array[Int]] = {
    val res = mutable.Map.empty[Int, Array[Int]]
...
object FPGrowth {
  class ArrayWrapper(val array: Array[Int]) extends Serializable {
    override def hashCode(): Int = java.util.Arrays.hashCode(this.array)

    override def equals(obj: Any): Boolean = {
      obj match {
        case obj: ArrayWrapper => java.util.Arrays.equals(this.array, obj.array)
